...
enum CMsgProtoBufHeader_ESessionDisposition : int {
  CMsgProtoBufHeader_ESessionDisposition_ESessionDispositionNormal = 0,
  CMsgProtoBufHeader_ESessionDisposition_ESessionDispositionDisconnect = 1
};
bool CMsgProtoBufHeader_ESessionDisposition_IsValid(int value);
constexpr CMsgProtoBufHeader_ESessionDisposition CMsgProtoBufHeader_ESessionDisposition_ESessionDisposition_MIN = CMsgProtoBufHeader_ESessionDisposition_ESessionDispositionNormal;
constexpr CMsgProtoBufHeader_ESessionDisposition CMsgProtoBufHeader_ESessionDisposition_ESessionDisposition_MAX = CMsgProtoBufHeader_ESessionDisposition_ESessionDispositionDisconnect;
...
enum EBanContentCheckResult : int {
  EBanContentCheckResult_NotScanned = 0,
  EBanContentCheckResult_Reset = 1,
  EBanContentCheckResult_NeedsChecking = 2,
  EBanContentCheckResult_VeryUnlikely = 5,
  EBanContentCheckResult_Unlikely = 30,
  EBanContentCheckResult_Possible = 50,
  EBanContentCheckResult_Likely = 75,
  EBanContentCheckResult_VeryLikely = 100
};
bool EBanContentCheckResult_IsValid(int value);
constexpr EBanContentCheckResult EBanContentCheckResult_MIN = EBanContentCheckResult_NotScanned;
constexpr EBanContentCheckResult EBanContentCheckResult_MAX = EBanContentCheckResult_VeryLikely;
...
constexpr EProtoClanEventType EProtoClanEventType_MIN = EClanOtherEvent;
constexpr EProtoClanEventType EProtoClanEventType_MAX = EClanInGameEventGeneral;
...
constexpr PartnerEventNotificationType PartnerEventNotificationType_MIN = EEventStart;
constexpr PartnerEventNotificationType PartnerEventNotificationType_MAX = EEventPartnerMaxType;
...
class CMsgProtoBufHeader PROTOBUF_FINAL :
 ...
 public:
  ...
  static constexpr ESessionDisposition ESessionDispositionNormal =
    CMsgProtoBufHeader_ESessionDisposition_ESessionDispositionNormal;
  static constexpr ESessionDisposition ESessionDispositionDisconnect =
    CMsgProtoBufHeader_ESessionDisposition_ESessionDispositionDisconnect;
...
class CCommunity_ClanAnnouncementInfo PROTOBUF_FINAL :
 ...
 public:
  ...
  bool has_ban_checresult() const;
  private:
  bool _internal_has_ban_checresult() const;
  public:
  void clear_ban_checresult();
  ::EBanContentCheckResult ban_checresult() const;
  void set_ban_checresult(::EBanContentCheckResult value);
  private:
  ::EBanContentCheckResult _internal_ban_checresult() const;
  void _internal_set_ban_checresult(::EBanContentCheckResult value);
  public:
...
// optional .EBanContentCheckResult ban_checresult = 16 [default = EBanContentCheckResult_NotScanned];
inline bool CCommunity_ClanAnnouncementInfo::_internal_has_ban_checresult() const {
  bool value = (_has_bits_[0] & 0x00008000u) != 0;
  return value;
}
inline bool CCommunity_ClanAnnouncementInfo::has_ban_checresult() const {
  return _internal_has_ban_checresult();
}
inline void CCommunity_ClanAnnouncementInfo::clear_ban_checresult() {
  ban_checresult_ = 0;
  _has_bits_[0] &= ~0x00008000u;
}
inline ::EBanContentCheckResult CCommunity_ClanAnnouncementInfo::_internal_ban_checresult() const {
  return static_cast< ::EBanContentCheckResult >(ban_checresult_);
}
inline ::EBanContentCheckResult CCommunity_ClanAnnouncementInfo::ban_checresult() const {
  // @@protoc_insertion_point(field_get:CCommunity_ClanAnnouncementInfo.ban_checresult)
  return _internal_ban_checresult();
}
inline void CCommunity_ClanAnnouncementInfo::_internal_set_ban_checresult(::EBanContentCheckResult value) {
  assert(::EBanContentCheckResult_IsValid(value));
  _has_bits_[0] |= 0x00008000u;
  ban_checresult_ = value;
}
inline void CCommunity_ClanAnnouncementInfo::set_ban_checresult(::EBanContentCheckResult value) {
  _internal_set_ban_checresult(value);
  // @@protoc_insertion_point(field_set:CCommunity_ClanAnnouncementInfo.ban_checresult)
}
