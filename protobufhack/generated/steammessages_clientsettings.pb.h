...
class CMsgClientSettings PROTOBUF_FINAL :
 ...
 public:
  ...
  bool has_g_background_br() const;
  private:
  bool _internal_has_g_background_br() const;
  public:
  void clear_g_background_br();
  ::PROTOBUF_NAMESPACE_ID::int32 g_background_br() const;
  void set_g_background_br(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_g_background_br() const;
  void _internal_set_g_background_br(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
...
// optional int32 g_background_br = 18210 [(.setting_store) = EClientSettingStore_CustomFunc, (.setting_default_int) = 12000];
inline bool CMsgClientSettings::_internal_has_g_background_br() const {
  bool value = (_has_bits_[3] & 0x02000000u) != 0;
  return value;
}
inline bool CMsgClientSettings::has_g_background_br() const {
  return _internal_has_g_background_br();
}
inline void CMsgClientSettings::clear_g_background_br() {
  g_background_br_ = 0;
  _has_bits_[3] &= ~0x02000000u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 CMsgClientSettings::_internal_g_background_br() const {
  return g_background_br_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 CMsgClientSettings::g_background_br() const {
  // @@protoc_insertion_point(field_get:CMsgClientSettings.g_background_br)
  return _internal_g_background_br();
}
inline void CMsgClientSettings::_internal_set_g_background_br(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[3] |= 0x02000000u;
  g_background_br_ = value;
}
inline void CMsgClientSettings::set_g_background_br(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_g_background_br(value);
  // @@protoc_insertion_point(field_set:CMsgClientSettings.g_background_br)
}
